...
namespace PoleFrance.Models
{
    ...
    partial void DeleteCandidature(Candidature instance);
		...
		public System.Data.Linq.Table<VuesInformationsGlobales> VuesInformationsGlobales
		{
			get
			{
				return this.GetTable<VuesInformationsGlobales>();
			}
		}
	}
    ...
    partial void OnIdLigueChanging(System.Nullable<decimal> value);
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.VuesInformationsGlobales")]
	public partial class VuesInformationsGlobales
	{
		...
		private string _EtablissementSouhait;
		
		private string _ClasseSouhait;
		
		private decimal _Poleid;
		
		public VuesInformationsGlobales()
		{
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_EtablissementSouhait", DbType="VarChar(200)")]
		public string EtablissementSouhait
		{
			get
			{
				return this._EtablissementSouhait;
			}
			set
			{
				if ((this._EtablissementSouhait != value))
				{
					this._EtablissementSouhait = value;
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ClasseSouhait", DbType="VarChar(150)")]
		public string ClasseSouhait
		{
			get
			{
				return this._ClasseSouhait;
			}
			set
			{
				if ((this._ClasseSouhait != value))
				{
					this._ClasseSouhait = value;
				}
			}
		}
